        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="settlementHistories"
                        to="/calculates/settlementHistories"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="remittanceManagements"
                        to="/remittances/remittanceManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'settlementHistories', 
                route: '/calculates/settlementHistories',
                ImageUrl: '',
            },
            { 
                title: 'RemittanceManagement', 
                description: '', 
                key: 'remittanceManagements', 
                route: '/remittances/remittanceManagements',
                ImageUrl: '',
            },
